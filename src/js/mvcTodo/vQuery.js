  ...
  $.fn = $.prototype = {
    ...
    init: function (cssSelector) {
      ...
      if ($.isString(cssSelector)) {
        this.elements = this.elements.slice.call(document.querySelectorAll(cssSelector));
        this.selector = cssSelector;
      } else {
        if ("length" in cssSelector) {
          this.elements = this.elements.slice.call(cssSelector);
        } else {
          this.elements.push(cssSelector);
        }
      }
